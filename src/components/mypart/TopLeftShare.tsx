...
const TopLeftShare = () => {
  ...
  <span className="tooltip3">
    <svg
      ...
      width="20"
      xmlns="http://www.w3.org/2000/svg"
      onClick={()=>window.open("https://api.whatsapp.com/send/?phone=%2B916203241318&text&type=phone_number&app_absent=0")}
    >
      <path
  ...
  <span className="tooltip8">
    <svg
      ...
      width="20"
      xmlns="http://www.w3.org/2000/svg"
      onClick={()=>window.open("https://www.reddit.com/user/ZealousidealStep900/")}
    >
      <path
