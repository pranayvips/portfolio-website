...
export function OpenButton(){
    return <button className="projectOpenButton">
...
export function GithubButton({onclick}:{onclick:Function}){
    return <button className="projectGithubButton" onClick={()=>onclick()} >
 <span className="svgContainer">
  <GitHubLogoIcon className="text-white w-full h-full m-2" />
 </span>
...
export function SquareBoxLoader(){
    return <div className="projectLoader">
...
export function ProjectFilter(){
  return <motion.button initial={{ x:100 ,opacity:0}}
      whileInView={{ x:0,opacity:1}}
      transition={{ duration: .5 }}
      viewport={{ once: false, amount: 0.5 }} className='projectFilter hidden sm:block self-center'> Filter
  <span></span>
</motion.button>
}